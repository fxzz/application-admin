...
public class UidapterBoardController {
	...
	public NexacroResult deleteCommunity(@ParamDataSet(name = "ds_del")Map<String, Object> ds_del) throws NexacroException {
		...
		uidapterSampleService.deleteCommunity(ds_del);
	...
	public NexacroResult selectCommunity(@ParamDataSet(name = "ds_search")Map<String, Object> ds_search) throws NexacroException {
		// ds_search {TEST=1, DataSetRowType=0}
		NexacroResult result = new NexacroResult();
		ArrayList<Map<String, Object>> ds_list = new ArrayList<>();
		
		ds_list = uidapterSampleService.selectCommunityList(ds_search);
